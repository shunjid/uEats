        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountPhoneNumber = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarrierAge = table.Column<int>(nullable: false),
                    CarrierStatus = table.Column<string>(nullable: true),
                    CarrierAverageRating = table.Column<float>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carriers_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsumerAge = table.Column<int>(nullable: false),
                    ChoiceOfTaste = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consumers_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantStatus = table.Column<string>(nullable: true),
                    RestaurantAverageRating = table.Column<float>(nullable: false),
                    AccountId = table.Column<string>(nullable: true),
                    LocationId = table.Column<int>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodRestaurantPrice = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodRestaurants", x => new { x.FoodId, x.RestaurantId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodRestaurantFoodId = table.Column<int>(nullable: true),
                    FoodRestaurantRestaurantId = table.Column<string>(nullable: true),
                    CarrierId = table.Column<string>(nullable: true),
                    IsDelivered = table.Column<bool>(nullable: false),
                    PurchaseRating = table.Column<int>(nullable: false),
                    PurchaseAmount = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Purchases", x => x.PurchaseId);
                    table.ForeignKey(
                        name: "FK_Purchases_Carriers_CarrierId",
                        column: x => x.CarrierId,
                        principalTable: "Carriers",
                        principalColumn: "CarrierId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Purchases_Consumers_ConsumerId",
                        column: x => x.ConsumerId,
                        principalTable: "Consumers",
                        principalColumn: "ConsumerId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Purchases_FoodRestaurants_FoodRestaurantFoodId_FoodRestaurantRestaurantId",
                        columns: x => new { x.FoodRestaurantFoodId, x.FoodRestaurantRestaurantId },
                        principalTable: "FoodRestaurants",
                        principalColumns: new[] { "FoodId", "RestaurantId" },
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_CarrierId",
                table: "Purchases",
                column: "CarrierId");

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_ConsumerId",
                table: "Purchases",
                column: "ConsumerId");

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_FoodRestaurantFoodId_FoodRestaurantRestaurantId",
                table: "Purchases",
                columns: new[] { "FoodRestaurantFoodId", "FoodRestaurantRestaurantId" });
